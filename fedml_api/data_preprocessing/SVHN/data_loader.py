...
def _data_transforms_SVHN():
    # SVHN_MEAN = [0.49139968, 0.48215827, 0.44653124]
    # SVHN_STD = [0.24703233, 0.24348505, 0.26158768]
...
def load_SVHN_data(datadir):
    ...
    SVHN_train_ds = SVHN_truncated(datadir, train='train', download=True, transform=train_transform)
    SVHN_test_ds = SVHN_truncated(datadir, train='test', download=True, transform=test_transform)
...
def get_dataloader_test_SVHN(datadir, train_bs, test_bs, dataidxs_train=None, dataidxs_test=None):
    ...
    train_ds = dl_obj(datadir, dataidxs=dataidxs_train, train='train', transform=transform_train, download=True)
    test_ds = dl_obj(datadir, dataidxs=dataidxs_test, train='test', transform=transform_test, download=True)
