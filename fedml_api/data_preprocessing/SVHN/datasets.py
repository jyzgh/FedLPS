...
class SVHN_truncated(data.Dataset):
    ...
    def __build_truncated_dataset__(self):
        ...
        # SVHN_dataobj = torch.utils.data.DataLoader(
        #     SVHN(self.root, self.train, self.transform, self.target_transform, self.download))
        ...
        if self.train == 'train':
            ...
            # target = np.array(SVHN_dataobj.targets)
